...
//CODE HERE
function sevenTeen(string){
  console.log(string.toUpperCase())
}
sevenTeen(sampleString)
...
console.log(emailCheck('wrongemail.com'))
...
//CODE HERE
function nineTeen(gold){
  chocolateFrogs = (gold/3)
  return chocolateFrogs
}
let totalFrogs = nineTeen(30)
...
//CODE HERE
function nineTeen2(gold){
  chocolateFrogs = (gold/3)
  return Math.trunc(chocolateFrogs)
}
let totalFrogs2 = nineTeen2(41)
